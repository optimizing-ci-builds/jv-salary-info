...
for file_name in file_names:
    ...
    if last_access_index < last_modify_index:
        ...
        if f'/home/runner/work/jv-salary-info/jv-salary-info/.git/' not in file_name:
...
os.mkdir(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis')
os.mkdir(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details')
...
save_path = f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/job.csv'
# write the current_run_id to the file job.csv
with open(save_path, 'w') as f:
    f.write(current_run_id  + ',' + job_id + ',' + f"jv-salary-info" + ',' + workflow)
...
if (info_flag == 1) :
    for step, (starting_index, ending_index) in steps.items():
        ...
        if step_name != '':
            if not os.path.exists(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}'):
                os.mkdir(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}')
            if created_file_count > 0: info_df[c]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c.csv')
            if modified_file_count > 0: info_df[m]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/m.csv')
            if cma > 0: info_df[c & m & a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/cma.csv')
            if cm_a > 0: info_df[c & m & _a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/cm_a.csv')
            if cm__a > 0: info_df[c & m & __a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/cm__a.csv')
            if c_ma > 0: info_df[c & ~m & a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c_ma.csv')
            if c_m_a > 0: info_df[c & ~m & _a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c_m_a.csv')
            if c_m__a > 0: info_df[c & ~m & __a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c_m__a.csv')
            if _cma > 0: info_df[~c & m & a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_cma.csv')
            if _cm_a > 0: info_df[~c & m & _a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_cm_a.csv')
            if _cm__a > 0: info_df[~c & m & __a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_cm__a.csv')
            if _c_ma > 0: info_df[~c & ~m & a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_c_ma.csv')
            if _c_m_a > 0: info_df[~c & ~m & _a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_c_m_a.csv')
            if _c_m__a > 0: info_df[~c & ~m & __a]["file_name"].to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_c_m__a.csv')
    ...
    step_df.to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/steps.csv')
    info_df.to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/files.csv')
    useful_df.to_csv(f'/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/useful.csv')
    directories = show_directories('/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/files.csv')
    string_version = ''
    for line in directories:
        string_version += line + '\n'
    with open("/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/directories.txt", "w+", encoding="utf-8") as f:
        f.write(string_version)
shutil.copy2("/home/runner/inotify-logs.csv", "/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis/")

size = 0
Folderpath = "/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis"
...
if size > 99000000:
    ...
    os.mkdir(Folderpath)
    shutil.move("/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis.zip", "/home/runner/work/jv-salary-info/jv-salary-info/optimizing-ci-builds-ci-analysis")
